...
import HeroImage from "../assets/imagens/amico.png";
    ...
    <div className="homePage">
        ...
        <Container>
          <Row className="header-box d-flex align-items-center">
            ...
            <Col lg="6" className="pt-lg-0 pt-5">
              <img src={HeroImage} alt="hero-image" className="animate_animated animate_fadeInUp" />
            </Col>
          </Row>
        </Container>
      </header>
      <div className="cursos w-100 min-vh-100">
        <Container>
          <Row>
            <Col>
              <h1 className="text-center fw-bold">Curso Teste</h1>
